...
(function($){
  ...
  <p><span style="background:gold"><strong>102</strong> <em><?php _e('The Gator Cache config file is not writable', 'gatorcache');?></em></span>  - <?php printf('Change the ownership of <strong>%s</strong> to <strong>%s</strong>. If this is not possible with your hosting, the file permissions should be set to "0777".', $libDir = self::$path . 'lib' . DIRECTORY_SEPARATOR . 'config.ini.php', $webUser);?></p>
  <p><span style="background:gold"><strong>103</strong> <em><?php _e('Wordpress cache file could not be copied', 'gatorcache');?></em></span>  - <?php printf('%s <strong>%s</strong> %s: <strong>%s</strong>.', __('Manually copy ', 'gatorcache'), $libDir . 'advanced-cache.php', __('to the following directory', 'gatorcache'), WP_CONTENT_DIR);?></p>
